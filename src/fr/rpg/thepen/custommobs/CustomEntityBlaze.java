...
public class CustomEntityBlaze extends EntityBlaze{
	...
	public CustomEntityBlaze(World w, String s){
		this(w);
    ...
    public static CustomEntityBlaze spawn(Location pos){
    	return CustomEntityBlaze.spawn(pos, "");
    }

    public static CustomEntityBlaze spawn(Location pos, String name){
    	return CustomEntityBlaze.spawn(((CraftWorld)pos.getWorld()).getHandle(), pos.getX(), pos.getY(), pos.getZ(), pos.getYaw(), pos.getPitch(), name);
    }
    
    public static CustomEntityBlaze spawn(World nmsWorld, double x, double y, double z, float yaw, float pitch, String name){
    	CustomEntityBlaze cez = new CustomEntityBlaze(nmsWorld, name);
