...
public class CustomEntityMagmaCube extends EntityMagmaCube{
	
	private double speed = 0.7, maxHealth = 20D, knockbackRes = 0D, followRange = 32D, strength = 2D;
	public CustomEntityMagmaCube(World w, String s){
		this(w);
    ...
    public static CustomEntityMagmaCube spawn(Location pos){
    	return CustomEntityMagmaCube.spawn(pos, "");
    }

    public static CustomEntityMagmaCube spawn(Location pos, String name){
    	return CustomEntityMagmaCube.spawn(((CraftWorld)pos.getWorld()).getHandle(), pos.getX(), pos.getY(), pos.getZ(), pos.getYaw(), pos.getPitch(), name);
    }
    
    public static CustomEntityMagmaCube spawn(World nmsWorld, double x, double y, double z, float yaw, float pitch, String name){
    	CustomEntityMagmaCube cez = new CustomEntityMagmaCube(nmsWorld, name);
