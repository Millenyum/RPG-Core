...
public class CustomEntityHorse extends EntityHorse{
	...
	public CustomEntityHorse(World w, String s){
		this(w);
    ...
    public static CustomEntityHorse spawn(Location pos){
    	return CustomEntityHorse.spawn(pos, "");
    }

    public static CustomEntityHorse spawn(Location pos, String name){
    	return CustomEntityHorse.spawn(((CraftWorld)pos.getWorld()).getHandle(), pos.getX(), pos.getY(), pos.getZ(), pos.getYaw(), pos.getPitch(), name);
    }
    
    public static CustomEntityHorse spawn(World nmsWorld, double x, double y, double z, float yaw, float pitch, String name){
    	CustomEntityHorse cez = new CustomEntityHorse(nmsWorld, name);
