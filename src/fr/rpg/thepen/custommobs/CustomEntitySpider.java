...
public class CustomEntitySpider extends EntitySpider{
	...
	public CustomEntitySpider(World w, String s){
		this(w);
    ...
    public static CustomEntitySpider spawn(Location pos){
    	return CustomEntitySpider.spawn(pos, "");
    }

    public static CustomEntitySpider spawn(Location pos, String name){
    	return CustomEntitySpider.spawn(((CraftWorld)pos.getWorld()).getHandle(), pos.getX(), pos.getY(), pos.getZ(), pos.getYaw(), pos.getPitch(), name);
    }
    
    public static CustomEntitySpider spawn(World nmsWorld, double x, double y, double z, float yaw, float pitch, String name){
    	CustomEntitySpider cez = new CustomEntitySpider(nmsWorld, name);
