...
public class CustomEntityCreeper extends EntityCreeper{
	...
	public CustomEntityCreeper(World w, String s){
		this(w);
    ...
    public static CustomEntityCreeper spawn(Location pos){
    	return CustomEntityCreeper.spawn(pos, "");
    }

    public static CustomEntityCreeper spawn(Location pos, String name){
    	return CustomEntityCreeper.spawn(((CraftWorld)pos.getWorld()).getHandle(), pos.getX(), pos.getY(), pos.getZ(), pos.getYaw(), pos.getPitch(), name);
    }
    
    public static CustomEntityCreeper spawn(World nmsWorld, double x, double y, double z, float yaw, float pitch, String name){
    	CustomEntityCreeper cez = new CustomEntityCreeper(nmsWorld, name);
